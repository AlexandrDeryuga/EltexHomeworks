...
/*
FillPanelbyDate - заполнить по уже почитанным данным , панели (отрисовка)

передаем  
sel - положение курсора
namelist - набор готовых данных
FullP - область данных где мы готовим путь
Filename - путь до каталога
wnd - в какое окно отрисовываем
N- количество файлов  в каталоге
cvisible - флаг надо ли показывать курсор
